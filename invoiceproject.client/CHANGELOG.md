...
- Create Angular project with ng: `ng new invoiceproject.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`invoiceproject.client.esproj`).
